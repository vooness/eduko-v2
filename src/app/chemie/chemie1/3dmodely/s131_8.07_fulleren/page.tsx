...
export default function Model3DPage() {
  ...
  const [modelRoughness, setModelRoughness] = useState(0.8); // Správná hodnota pro realistický vzhled
  const [modelMetalness, setModelMetalness] = useState(0.5); // Zvýšeno z 0
  ...
  // Cesta k modelu
  const modelPath = "/3DModel/s131_8.07_fulleren.glb";
